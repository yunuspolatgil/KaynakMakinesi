...
namespace KaynakMakinesi.Infrastructure.Plc.Profile
{
    ...
    public sealed class Gmt496Profile : IPlcProfile
    {
        ...
        private readonly List<ProfileRule> _rules = new List<ProfileRule>
        {
            ...
            new ProfileRule
            { 
                From1Based = 1,  // MB0 = 1 (Coil adresleri 1-based)
                To1Based = 9999, 
            ...
            new ProfileRule
            { 
                From1Based = 10001,  // IP0 = 10001 (Discrete Input 1-based)
                To1Based = 19999, 
            ...
            new ProfileRule
            { 
                From1Based = 30001,  // IW0 = 30001 (Input Register 1-based)
                To1Based = 39999, 
        ...
        public int GetHumanBase1Based(ModbusArea area)
        {
            ...
            // DİKKAT: GMT PLC operand adresleri 1'den başlar!
            // MW0 = 40001, IP0 = 10001, IW0 = 30001, MB0 = 1
            switch (area)
            {
                case ModbusArea.Coil: return 1;  // Coil adresleri 1'den başlar
        ...
        public bool TryResolveByOperand(string operand, out ResolvedAddress resolved, out string error)
        {
            ...
            {
                case "MW":
                    address1Based = 40001 + idx;  // MW0 -> 40001 (1-based Modbus)
                    break;
                case "MI":
                ...
                case "MF":
                    ...
                    break;
                case "MB":
                    // MB0 -> Coil 1 (1-based Modbus)
                    address1Based = 1 + idx;  // MB0 -> 1, MB1 -> 2
                    break;
                case "IP":
                    // DÜZELTİLDİ: IP0 = 10001 (PLC dokümantasyonuna göre)
